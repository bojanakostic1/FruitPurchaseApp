        ...
        dpf.dodajAddActionListener(new ActionListener() {
            ...
            private void dodajProizvodjaca(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(dpf, "Sistem je zamaptio proizvođača.", "Uspešno", JOptionPane.INFORMATION_MESSAGE);
                    dpf.dispose();
                } catch (Exception ex) {
        ...
        dpf.izmeniAddActionListener(new ActionListener() {
            ...
            private void izmeniProizvodjaca(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(dpf, "Sistem je ažurirao proizvođača.", "Uspešno", JOptionPane.INFORMATION_MESSAGE);
                    dpf.dispose();
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(dpf, "Sistem ne može da ažurira proizvođača.", "Greška", JOptionPane.ERROR_MESSAGE);
                }
